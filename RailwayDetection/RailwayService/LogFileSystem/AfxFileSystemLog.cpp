// Re-mine.LogPlugin.FileSystemLog.cpp : 定义 DLL 的初始化例程。
//
...
// CRemineLogPluginFileSystemLogApp 构造
...
// 唯一的一个 CRemineLogPluginFileSystemLogApp 对象

CLogFileSystemApp theApp;


// CRemineLogPluginFileSystemLogApp 初始化
