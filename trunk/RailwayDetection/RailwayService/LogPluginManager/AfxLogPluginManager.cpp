// Re-mine.LogPlugin.LogPluginManager.cpp : 定义 DLL 的初始化例程。
//
...
// CRemineLogPluginLogPluginManagerApp 构造
...
// 唯一的一个 CRemineLogPluginLogPluginManagerApp 对象

CLogPluginManagerApp theApp;


// CRemineLogPluginLogPluginManagerApp 初始化
