// LogPluginManager.cpp : Defines the initialization routines for the DLL.
//
...
// CLogPluginManagerApp construction
...
// The one and only CLogPluginManagerApp object

CLogPluginManagerApp theApp;


// CLogPluginManagerApp initialization
